...
- Last analyzed: 2026-08-13 at commit `848b4ab`.
...
- Each Unity project receives local `file:` references. Coplay is downloaded once under the user's local application-data cache.
